...
export const ASSEMBLYAI_VOICES: VoiceOption[] = [
  ...
  { id: "estelle", name: "Estelle", gender: "Female", accent: "French/US", style: "Sophisticated & Calming", description: "Luxury medspas, wellness, and boutique studios" },
  ...
  { id: "jean", name: "Jean", gender: "Female", accent: "US", style: "Balanced & Engaging", description: "High-end salons, spas, and hospitality" },
  ...
  { id: "lola", name: "Lola", gender: "Female", accent: "Spanish/US", style: "Vibrant & Playful", description: "Trendsetting salons and modern creative studios" },
  ...
  { id: "rafael", name: "Rafael", gender: "Male", accent: "Portuguese/US", style: "Dynamic & Charming", description: "Energetic and warm client service" },
