...
export const ASSEMBLYAI_VOICES: VoiceOption[] = [
  ...
  { id: "george", name: "George", gender: "Male", accent: "US", style: "Conversational & Warm", description: "Clear, friendly, and approachable demeanor" },
  { id: "giovanni", name: "Giovanni", gender: "Male", accent: "Italian", style: "Expressive & Confident", description: "Charismatic, welcoming and memorable" },
  { id: "jane", name: "Jane", gender: "Female", accent: "US", style: "Articulate & Direct", description: "Clear, authoritative corporate receptionist" },
  { id: "jean", name: "Jean", gender: "Male", accent: "US", style: "Balanced & Engaging", description: "Smooth, articulate, and resonant male professional tone" },
  { id: "juergen", name: "Juergen", gender: "Male", accent: "German", style: "Resonant & Precise", description: "Direct, confident, and reliable tone" },
  { id: "lola", name: "Lola", gender: "Female", accent: "Spanish", style: "Vibrant & Playful", description: "Trendsetting salons and modern creative studios" },
  ...
  { id: "paul", name: "Paul", gender: "Male", accent: "UK", style: "Authoritative & Smooth", description: "Trustworthy professional consultation" },
  { id: "rafael", name: "Rafael", gender: "Male", accent: "Portuguese", style: "Dynamic & Charming", description: "Energetic and warm client service" },
  { id: "vera", name: "Vera", gender: "Female", accent: "UK", style: "Elegant & Polished", description: "Upscale aesthetic practices and VIP concierge" },
];
        ...
        <div style={cs.card}>
          ...
          {(() => {
            ...
            return (
              ...
              >
                <span style={{ fontWeight: 600, color: "var(--text)" }}>{currentVoice.name}</span>
                <span>&bull;</span>
                <span>{currentVoice.gender}</span>
                <span>&bull;</span>
                <span>{currentVoice.accent}</span>
                <span>&bull;</span>
                <span>{currentVoice.style} — {currentVoice.description}</span>
              </div>
            );
          })()}
